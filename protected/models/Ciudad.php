...
class Ciudad extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'ordenMudanzas' => array(self::HAS_MANY, 'OrdenMudanza', 'ciudad_origen'),
			'ordenMudanzas1' => array(self::HAS_MANY, 'OrdenMudanza', 'ciudad_destino'),
		);
	}
	...
	public function getCiudadCompleto(){
