...
<?php 
	switch ($model->estado) {
		case 1: case 2: case 3:
			echo CHtml::link('Cancelar solicitud',array('ordenMudanza/cancelar/'.$model->id),array('confirm'=>'¿Confirme que desea cancelar esta orden?','class'=>'btn btn-danger btn-flat'));
			break;		
		default:
			# code...
			break;
