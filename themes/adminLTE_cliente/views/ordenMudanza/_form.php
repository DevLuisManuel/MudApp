	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<?php if($model->fecha_recojida!=null){$model->fecha_recojida = date("Y-m-d\TH:i:s",strtotime($model->fecha_recojida));} ?>
				<?php echo $form->dateTimeLocalField($model,'fecha_recojida',array('class'=>'form-control','min'=>date('Y-m-d\TH:i:00',strtotime("+1 days")))); ?>
				<?php echo $form->error($model,'fecha_recojida',array('class'=>'text-danger')); ?>
			</div>
