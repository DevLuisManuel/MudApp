...
<html lang="es">
  <head>
    ...
    -->
    <link href="<?php echo Yii::app()->theme->baseUrl; ?>/dist/css/skins/skin-blue.min.css" rel="stylesheet" type="text/css" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/" class="logo">
          ...
          <span class="logo-lg"><?php echo CHtml::image(Yii::app()->theme->baseUrl.'/img/logo_32.png',''); ?><b>Mud</b>App Clientes</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <!-- Navbar Right Menu -->
          <?php echo $this->renderPartial('/layouts/nav_right'); ?>
        </nav>
      </header>
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2015 <a href="#">MudApp</a>.</strong> All rights reserved.
      </footer>
