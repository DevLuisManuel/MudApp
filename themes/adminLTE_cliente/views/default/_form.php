		...
		<?php if(isset($model->isNewRecord)): ?>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<?php echo $form->error($model,'repassword',array('class'=>'text-danger')); ?>						
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<?php echo CHtml::link('Cancelar',array('/index.php'),array('class'=>'btn btn-danger btn-block btn-flat')); ?>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<?php echo CHtml::submitButton('Actualizar cliente',array('class'=>'btn btn-success btn-block btn-flat')); ?>
			</div>
		</div>
		<?php endif; ?>
		<?php $this->endWidget(); ?>	
