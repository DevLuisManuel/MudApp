...
<html lang="es">
  <head>
    ...
    -->
    <link href="<?php echo Yii::app()->theme->baseUrl; ?>/dist/css/skins/skin-yellow.min.css" rel="stylesheet" type="text/css" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/" class="logo">
          ...
          <span class="logo-lg"><?php echo CHtml::image(Yii::app()->theme->baseUrl.'/img/logo_32.png',''); ?><b>Mud</b>App</span>
        </a>
